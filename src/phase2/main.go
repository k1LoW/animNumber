...
var digitMedians = []DigitMedians{
	...
	{Char: '０', Phases: []Phase{
		{Number: 1, Parts: []Part{
			...
			{Letter: "b", Median: []Point{
				{-200, 85}, {510, 85}, {589, 110}, {634, 170}, {668, 250},
	...
	{Char: '６', Phases: []Phase{
		{Number: 1, Parts: []Part{
			...
			{Letter: "b", Median: []Point{
				{-199, -50}, {-199, 100}, {576, 100}, {653, 140}, {697, 220},
	...
	{Char: '８', Phases: []Phase{
		{Number: 1, Parts: []Part{
			...
			{Letter: "b", Median: []Point{
				{-178, -200}, {-178, -420}, {168, -420}, {488, -420}, {488, 80},
	...
	{Char: '９', Phases: []Phase{
		{Number: 1, Parts: []Part{
			...
			{Letter: "b",
				Median: []Point{
					{434, -380}, {434, 320}, {488, 320}, {531, 350}, {564, 380},
					{586, 410}, {629, 440}, {651, 470}, {672, 500}, {694, 540},
