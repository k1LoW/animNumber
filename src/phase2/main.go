...
var digitMedians = []DigitMedians{
	...
	{Char: '０', Phases: []Phase{
		{Number: 1, Parts: []Part{
			...
			{Letter: "b", Median: []Point{
				{-235, 85}, {510, 85}, {589, 110}, {634, 170}, {668, 250},
	...
	{Char: '３', Phases: []Phase{
		{Number: 1, Parts: []Part{
			{Letter: "a", Median: []Point{
				{367, 610}, {422, 650}, {521, 650}, {598, 630}, {653, 600},
			...
			{Letter: "b",
				Median: []Point{
					{477, 1149}, {477, 410}, {554, 390}, {631, 360}, {686, 310},
					{697, 240}, {675, 170}, {620, 110}, {521, 90}, {422, 100},
					{356, 140}, {323, 170},
				},
				LeadOut: []Point{{-233, 170}},
			},
		}},
	}},
	{Char: '４', Phases: []Phase{
	...
	{Char: '６', Phases: []Phase{
		{Number: 1, Parts: []Part{
			...
			{Letter: "b", Median: []Point{
				{-272, 100}, {576, 100}, {653, 140}, {697, 220}, {697, 290},
				{653, 370}, {576, 420}, {488, 430}, {411, 405}, {378, 380},
				{334, 340},
			}},
		}},
	}},
	...
	{Char: '８', Phases: []Phase{
		{Number: 1, Parts: []Part{
			...
			{Letter: "b", Median: []Point{
				{-230, -420}, {168, -420}, {488, -420}, {488, 80}, {433, 80},
				{366, 110}, {333, 170}, {322, 230}, {322, 290}, {344, 350},
				{399, 380}, {455, 410}, {532, 430}, {587, 460}, {631, 490},
				{675, 510}, {697, 540}, {703, 570},
			}},
		}},
	}},
	{Char: '９', Phases: []Phase{
		{Number: 1, Parts: []Part{
			...
			{Letter: "b",
				Median: []Point{
					{434, -350}, {434, 320}, {488, 320}, {531, 350}, {564, 380},
					{586, 410}, {629, 440}, {651, 470}, {672, 500}, {694, 540},
					{699, 580}, {699, 620}, {694, 650},
				},
				LeadOut: []Point{{1435, 650}},
			},
			{Letter: "c",
				Median: []Point{
