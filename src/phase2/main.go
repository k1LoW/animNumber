...
var digitMedians = []DigitMedians{
	...
	{Char: '8', Phases: []Phase{
		{Number: 1, Parts: []Part{
			...
			// is occluded by c1a.
			{Letter: "a", Median: []Point{
				{660, 600}, {640, 620}, {610, 650}, {510, 650}, {430, 650}, {400, 620},
			...
			{Letter: "b", Median: []Point{
				{-188, -420}, {200, -420}, {490, -420}, {490, 80},
	...
	{Char: '８', Phases: []Phase{
		{Number: 1, Parts: []Part{
			{Letter: "a", Median: []Point{
				{670, 600}, {653, 620}, {620, 650}, {510, 650}, {421, 650}, {388, 620},
			...
			{Letter: "b", Median: []Point{
				{-35, -200}, {-35, -420}, {168, -420}, {488, -420}, {488, 80},
