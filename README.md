...
- **All digits** are placed at Klee One's native ×1.0 scale with the baseline at animCJK source y=28, chosen so the digit body sits visually centered in the 1024×1024 viewBox used by animCJK.
